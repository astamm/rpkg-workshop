...
- Create a `README` file that briefly explains what your package does (it will appear on your GitHub project’s homepage)
  ```{r, eval=FALSE}
  usethis::use_readme_rmd()
  ```
- Open the file `README.Rmd` and knit it.
